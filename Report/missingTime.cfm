...
<cfquery name="load" datasource="#application.DSN#">
	SELECT P.publisherID, SG.groupName, SR.lname, SR.fname, SR.imonth, SR.iyear, P.telephone, P.mobile, SR.serviceYear
...
<div id="content">
                ...
                <h2>#load.recordCount# Missing Time</h2>
...
<a href="http://beta.timothycunningham.com/publishercard/addTime.cfm?publisherID=#publisherID#&imonth=#imonth#&iyear=#iyear#&serviceYear=#serviceYear#">
#lname#, #fname#</a<</td>
